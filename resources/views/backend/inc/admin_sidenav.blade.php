    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                {{-- Dashboard --}}
                @if(auth()->user() && auth()->user()->can('admin_dashboard'))
                ...
                @if (addon_is_activated('pos_system') && (auth()->user()->can('pos_manager') || auth()->user()->can('pos_configuration')))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('pos_manager'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('pos_configuration'))
                                <li class="aiz-side-nav-item">
                ...
                <!-- Product -->
                @if(auth()->user() && auth()->user()->canAny(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('add_new_product'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('show_all_products'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('show_in_house_products'))
                                <li class="aiz-side-nav-item">
                            ...
                            @if(get_setting('vendor_system_activation') == 1)
                                @if(auth()->user() && auth()->user()->can('show_seller_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                            @endif
                            @if(auth()->user() && auth()->user()->can('show_digital_products'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('product_bulk_import'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('product_bulk_export'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_product_categories'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_all_brands'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_product_attributes'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_colors'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_product_reviews'))
                                <li class="aiz-side-nav-item">
                ...
                @if(addon_is_activated('auction'))
                    @if(auth()->user() && auth()->user()->canAny(['add_auction_product','view_all_auction_products','view_inhouse_auction_products','view_seller_auction_products','view_auction_product_orders']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <!--Submenu-->
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('add_auction_product'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_all_auction_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_inhouse_auction_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_seller_auction_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_auction_product_orders'))
                                    <li class="aiz-side-nav-item">
                ...
                @if(addon_is_activated('wholesale'))
                    @if(auth()->user() && auth()->user()->canAny(['add_wholesale_product','view_all_wholesale_products','view_inhouse_wholesale_products','view_sellers_wholesale_products']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('add_wholesale_product'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_all_wholesale_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_inhouse_wholesale_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_sellers_wholesale_products'))
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Sale -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_orders'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_inhouse_orders'))
                                <li class="aiz-side-nav-item">
                            ...
                            @if(auth()->user() && auth()->user()->can('view_seller_orders'))
                                <li class="aiz-side-nav-item">
                            ...
                            @if(auth()->user() && auth()->user()->can('view_pickup_point_orders'))
                                <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('delivery_boy'))
                    @if(auth()->user() && auth()->user()->canAny(['view_all_delivery_boy','add_delivery_boy','delivery_boy_payment_history','collected_histories_from_delivery_boy','order_cancle_request_by_delivery_boy','delivery_boy_configuration']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('view_all_delivery_boy'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('add_delivery_boy'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('delivery_boy_payment_history'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('collected_histories_from_delivery_boy'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('order_cancle_request_by_delivery_boy'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('delivery_boy_configuration'))
                                    <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('refund_request'))
                    @if(auth()->user() && auth()->user()->canAny(['view_refund_requests','view_approved_refund_requests','view_rejected_refund_requests','refund_request_configuration']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('view_refund_requests'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_approved_refund_requests'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_rejected_refund_requests'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('refund_request_configuration'))
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Customers -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_customers','view_classified_products','view_classified_packages']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_customers'))
                                <li class="aiz-side-nav-item">
                            ...
                            @if(get_setting('classified_product') == 1)
                                @if(auth()->user() && auth()->user()->can('view_classified_products'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_classified_packages'))
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Sellers -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_seller'))
                                <li class="aiz-side-nav-item">
                                    @php
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('seller_payment_history'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_seller_payout_requests'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('seller_commission_configuration'))
                                <li class="aiz-side-nav-item">
                            ...
                            @if (addon_is_activated('seller_subscription'))
                                @if(auth()->user() && auth()->user()->can('view_all_seller_packages'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                            @endif
                            @if(auth()->user() && auth()->user()->can('seller_verification_form_configuration'))
                                <li class="aiz-side-nav-item">
                ...
                <!-- Reports -->
                @if(auth()->user() && auth()->user()->canAny(['in_house_product_sale_report','seller_products_sale_report','products_stock_report','product_wishlist_report','user_search_report','commission_history_report','wallet_transaction_report']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('in_house_product_sale_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('seller_products_sale_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('products_stock_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('product_wishlist_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('user_search_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('commission_history_report'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('wallet_transaction_report'))
                                <li class="aiz-side-nav-item">
                ...
                <!--Blog System-->
                @if(auth()->user() && auth()->user()->canAny(['view_blogs','view_blog_categories']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_blogs'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_blog_categories'))
                                <li class="aiz-side-nav-item">
                ...
                <!-- marketing -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_flash_deals','send_newsletter','send_bulk_sms','view_all_subscribers','view_all_coupons']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-bullhorn aiz-side-nav-icon"></i>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_flash_deals'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('send_newsletter'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_all_subscribers'))
                                <li class="aiz-side-nav-item">
                ...
                <!-- Support -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_support_tickets','view_all_product_conversations','view_all_product_queries']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_support_tickets'))
                                @php
                            ...
                            @if(auth()->user() && auth()->user()->can('view_all_product_conversations'))
                                @php
                            ...
                            @if (get_setting('product_query_activation') == 1)
                                @if(auth()->user() && auth()->user()->can('view_all_product_queries'))
                                    <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('affiliate_system'))
                    @if(auth()->user() && auth()->user()->canAny(['affiliate_registration_form_config','affiliate_configurations','view_affiliate_users','view_all_referral_users','view_affiliate_withdraw_requests','view_affiliate_logs']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <i class="las la-link aiz-side-nav-icon"></i>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('affiliate_registration_form_config'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('affiliate_configurations'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_affiliate_users'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_all_referral_users'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_affiliate_withdraw_requests'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_affiliate_logs'))
                                    <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('offline_payment'))
                    @if(auth()->user() && auth()->user()->canAny(['view_all_manual_payment_methods','view_all_offline_wallet_recharges','view_all_offline_customer_package_payments','view_all_offline_seller_package_payments']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('view_all_manual_payment_methods'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_all_offline_wallet_recharges'))
                                    <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('club_point'))
                    @if(auth()->user() && auth()->user()->canAny(['club_point_configurations','set_club_points','view_users_club_points']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('club_point_configurations'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('set_club_points'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('view_users_club_points'))
                                    <li class="aiz-side-nav-item">
                ...
                @if (addon_is_activated('otp_system'))
                    @if(auth()->user() && auth()->user()->canAny(['otp_configurations','sms_templates','sms_providers_configurations','send_bulk_sms']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('otp_configurations'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('sms_templates'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('sms_providers_configurations'))
                                    <li class="aiz-side-nav-item">
                ...
                @if(addon_is_activated('african_pg'))
                    @if(auth()->user() && auth()->user()->canAny(['african_pg_configuration','african_pg_credentials_configuration']))
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <i class="las la-phone aiz-side-nav-icon"></i>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(auth()->user() && auth()->user()->can('african_pg_configuration'))
                                    <li class="aiz-side-nav-item">
                                ...
                                @endif
                                @if(auth()->user() && auth()->user()->can('african_pg_credentials_configuration'))
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Website Setup -->
                @if(auth()->user() && auth()->user()->canAny(['header_setup','footer_setup','view_all_website_pages','website_appearance']))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('header_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('footer_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_all_website_pages'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('website_appearance'))
                                <li class="aiz-side-nav-item">
                ...
                @if(auth()->user() && auth()->user()->canAny(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('general_settings'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('features_activation'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('language_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('currency_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('vat_&_tax_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('pickup_point_setup'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('smtp_settings'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('payment_methods_configurations'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('order_configuration'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('file_system_&_cache_configuration'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('social_media_logins'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->canAny(['facebook_chat','facebook_comment']))
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        @if(auth()->user() && auth()->user()->can('facebook_chat'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('facebook_comment'))
                                            <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->canAny(['analytics_tools_configuration','google_recaptcha_configuration','google_map_setting','google_firebase_setting']))
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        @if(auth()->user() && auth()->user()->can('analytics_tools_configuration'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('google_recaptcha_configuration'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('google_map_setting'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('google_firebase_setting'))
                                            <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->canAny(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers']))
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        @if(auth()->user() && auth()->user()->can('shipping_configuration'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('shipping_country_setting'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('manage_shipping_states'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('manage_shipping_cities'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('manage_zones'))
                                            <li class="aiz-side-nav-item">
                                        ...
                                        @endif
                                        @if(auth()->user() && auth()->user()->can('manage_carriers'))
                                            <li class="aiz-side-nav-item">
                ...
                <!-- Staffs -->
                @if(auth()->user() && auth()->user()->canAny(['view_all_staffs','view_staff_roles']))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @if(auth()->user() && auth()->user()->can('view_all_staffs'))
                                <li class="aiz-side-nav-item">
                            ...
                            @endif
                            @if(auth()->user() && auth()->user()->can('view_staff_roles'))
                                <li class="aiz-side-nav-item">
